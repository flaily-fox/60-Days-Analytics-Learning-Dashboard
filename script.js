...
const roadmapData = [
    ...
    { day: 1, week: 1, topic: 'Python Fundamentals', sub: 'Environment Setup & Basics', concepts: ['Install Python, Jupyter', 'Variables, Data Types', 'Operators'], time: 2, resource: 'https://www.youtube.com/watch?v=_uQrJ0TkZlc', project: 'Simple calculator script.' },
    { day: 2, week: 1, topic: 'Python Fundamentals', sub: 'Control Flow', concepts: ['If-else statements', 'For & While loops', 'Break & Continue'], time: 2, resource: 'https://www.youtube.com/watch?v=_uQrJ0TkZlc', project: 'Guess the number game.' },
    { day: 3, week: 1, topic: 'Python Fundamentals', sub: 'Data Structures & Functions', concepts: ['Lists, Tuples, Dictionaries', 'Sets', 'String manipulation', 'Defining functions', 'Modules'], time: 2, resource: 'https://www.youtube.com/watch?v=_uQrJ0TkZlc', project: 'Simple contact book with functions.' },
    { day: 4, week: 1, topic: 'SQL Fundamentals', sub: 'Basic Queries', concepts: ['SELECT, FROM, WHERE', 'ORDER BY, LIMIT', 'Basic operators'], time: 3, resource: 'https://youtu.be/hlGoQC332VM?si=SFRnG8pLEFNlSBZm', project: 'Query a sample database for basic data.' },
    { day: 5, week: 1, topic: 'SQL Fundamentals', sub: 'Joins & Aggregations', concepts: ['INNER, LEFT, RIGHT Joins', 'GROUP BY', 'COUNT, SUM, AVG'], time: 4, resource: 'https://www.youtube.com/watch?v=t60b_MplxAA&list=PLOghUv2IDLKHKlkQNuzN8SPLYuVhhLlpa', project: 'Join two tables and calculate summary stats.' },
    { day: 6, week: 1, topic: 'SQL Fundamentals', sub: 'Advanced SQL & Subqueries', concepts: ['Subqueries', 'CASE statements', 'Window Functions (intro)'], time: 4, resource: 'https://www.youtube.com/watch?v=M-55BmjOuXY', project: 'Solve intermediate SQL problems online.' },
